    ...
    <section id="background">
      <Container  className='block'>
        ...
        <p>
          ...
          о том, чем заниматься в будущем, если не работать на заводах - я решил начать с
          Веб-разработки. Узнав о моих планах друг из среды посоветовал мне курс
          от Angela Yu на Udemy, собственно{" "}
